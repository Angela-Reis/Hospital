...
namespace Hospital.Controllers
{
    public class UtentesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NumTelemovel,Email,Nome,NumUtente,NIF,DataNascimento,Sexo,Foto")] Utentes utentes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NumTelemovel,Email,Nome,NumUtente,NIF,DataNascimento,Sexo,Foto")] Utentes utentes)
        {
            if (id != utentes.Id)
            {
                return NotFound();
